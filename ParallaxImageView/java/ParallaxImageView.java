...
public class ParallaxImageView extends ImageView
{
	...
	{
		TypedArray arr = getContext().obtainStyledAttributes(attrs, R.styleable.ParallaxImageViewAttrs);
		int reverse = arr.getInt(R.styleable.ParallaxImageViewAttrs_reverse, 1);

		updateOnDraw = arr.getBoolean(R.styleable.ParallaxImageViewAttrs_update_onDraw, false);
		blockParallaxX = arr.getBoolean(R.styleable.ParallaxImageViewAttrs_block_parallax_x, false);
		blockParallaxY = arr.getBoolean(R.styleable.ParallaxImageViewAttrs_block_parallax_y, false);
		interpolator = InterpolatorSelector.interpolatorId(arr.getInt(R.styleable.ParallaxImageViewAttrs_interpolation, 0));
